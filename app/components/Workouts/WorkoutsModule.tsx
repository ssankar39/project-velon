    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto p-4">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-gray-900">Log Workout</h3>
        </div>
        ...
        <form onSubmit={handleAddWorkout} className="space-y-4">
          <div>
            <input
              ...
              required
              className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 text-gray-900 placeholder-gray-500"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-6 py-3 bg-gradient-to-r from-green-500 to-teal-600 text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-gray-900">Today&apos;s Workouts</h3>
        </div>
        ...
        {loading && workouts.length === 0 ? (
          ...
          <div className="space-y-3 mb-4">
            {workouts.map((workout) => (
              <div
                key={workout.id}
                className="flex items-center justify-between p-3 bg-gray-50 border-l-4 border-green-500 rounded"
              >
                ...
                <div className="flex items-center gap-3">
                  <p className="text-lg font-semibold text-green-600">{workout.caloriesBurned} kcal</p>
                  <button
